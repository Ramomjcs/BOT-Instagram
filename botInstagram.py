from selenium import webdriver #navegar pela internet
from selenium.webdriver.common.keys import Keys #usar seta pra baixo, tab, etc
import time #Bib pra fingir ser humano
import random
...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(
            executable_path=r"C:\Users\ramom\Downloads\geckodriver"
    ...
    def login(self):
        ...
        user_element = driver.find_element_by_xpath(
            "//input[@name='username']") #colocar o login
        user_element.clear()
        time.sleep(random.randint(4, 6))
        user_element.send_keys(self.username)
        time.sleep(random.randint(4, 6))
        password_element = driver.find_element_by_xpath(
            "//input[@name='password']") #colocar senha
